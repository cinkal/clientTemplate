...
var ScrollBar=(function(_super){
	...
	*/
	...
	__proto.changeSize=function(){
		...
		this.resetPositions();
		this.event(/*laya.events.Event.CHANGE*/"change");
		this.changeHandler && this.changeHandler.runWith([this.value,this.max]);
	}
	...
	*/
	__getset(0,__proto,'value',function(){
		...
		if (v!==this._value){
			...
			this.event(/*laya.events.Event.CHANGE*/"change");
			this.changeHandler && this.changeHandler.runWith([this._value,this.max]);
		}
	});
